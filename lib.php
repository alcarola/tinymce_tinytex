...
/**
 * Plugin for OU equation insertion dialog.
 ...
 */
class tinymce_tinytex extends editor_tinymce_plugin {
    /** @var array list of buttons defined by this plugin */
    protected $buttons = array('tinytex');

    protected function update_init_params(array &$params, context $context,
            array $options = null) {

        // Add button before 'nonbreaking' in advancedbuttons3.
        $this->add_button_before($params, 3, 'tinytex', 'nonbreaking');
